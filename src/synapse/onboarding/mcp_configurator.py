...
_SYNAPSE_ENTRY = {"command": "synapse-mcp", "args": []}
...
def write_mcp_config(config_path: Path, servers_key: str = "mcpServers") -> None:
    """Merge synapse entry into an MCP client config file. Atomic write."""
    existing: dict = {}
    ...
    existing.setdefault(servers_key, {})["synapse"] = _SYNAPSE_ENTRY
