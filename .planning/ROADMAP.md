...
Plans:
- [ ] 05-01-PLAN.md — Python HTTP extractor (FastAPI/Flask/Django SERVES + requests HTTP_CALLS) with plugin wiring
- [x] 05-02-PLAN.md — TypeScript server-side extension (Express/Fastify/Hono SERVES added to existing extractor)
- [ ] 05-03-PLAN.md — Java HTTP extractor (Spring SERVES + RestTemplate/WebClient/java.net.http HTTP_CALLS) with plugin wiring
