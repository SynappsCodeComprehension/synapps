...
def test_empty_source(extractor):
    assert extractor.extract("/proj/MyClass.java", "", {}) == []
...
"""
    ...
    extractor.extract("/proj/MyClass.java", source, symbol_map)
    assert extractor._sites_seen == 3


def test_sites_seen_zero_for_empty_source(extractor):
    extractor.extract("/proj/MyClass.java", "", {})
...
"""
    ...
    extractor.extract("/proj/A.java", source_three, symbol_map_three)
    assert extractor._sites_seen == 3
