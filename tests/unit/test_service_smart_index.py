...
def svc(conn, registry):
    return SynappsService(conn, registry=registry)
...
@patch("synapps.service.indexing._git_sync_project")
@patch("synapps.service.indexing.compute_git_diff")
@patch("synapps.service.indexing.get_last_indexed_commit", return_value="stored_sha")
@patch("synapps.service.indexing.is_git_repo", return_value=True)
...
@patch("synapps.service.indexing._git_sync_project")
@patch("synapps.service.indexing.compute_git_diff")
@patch("synapps.service.indexing.get_last_indexed_commit", return_value="sha1")
@patch("synapps.service.indexing.is_git_repo", return_value=True)
